...
;(function () {
  ...
  function ensureStyles() {
    ...
    var css = [
      ...
      '.' + BLOCK_CLASS + ' .dg-gb-caret{flex:0 0 auto;font-size:var(--dg-text-xs);color:var(--text-muted,#9AA1AE)}',
      ...
      '.' + BLOCK_CLASS + ' .dg-gb-chip{padding:3px 9px;border-radius:999px;font-size:var(--dg-text-xs);font-weight:700;',
