...
export const state = {
  ...
  tabOrder: ['framer', 'preflight', 'sql', 'python', 'r', 'clean', 'validate', 'diff', 'visualize', 'glowcanvas', 'drillfloor', 'cleaningcrew', 'story', 'twin', 'watch', 'meeting', 'diplomacy', 'proofroom', 'convergence', 'crucible', 'copilot'],
};
