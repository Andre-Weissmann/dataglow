...
export const state = {
  ...
  tabOrder: ['framer', 'preflight', 'sql', 'python', 'r', 'clean', 'validate', 'diff', 'visualize', 'glowcanvas', 'drillfloor', 'story', 'twin', 'watch', 'meeting', 'diplomacy', 'proofroom', 'convergence', 'crucible', 'copilot'],
};
