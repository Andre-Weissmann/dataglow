...
export const state = {
  ...
  tabOrder: ['preflight', 'sql', 'clean', 'validate', 'nlsql', 'dvc', 'framer', 'python', 'r', 'diff', 'visualize', 'glowcanvas', 'pivot', 'drillfloor', 'cleaningcrew', 'story', 'twin', 'watch', 'meeting', 'diplomacy', 'proofroom', 'trustpassport', 'convergence', 'crucible', 'copilot', 'joinbuilder', 'portfolio'],
};
