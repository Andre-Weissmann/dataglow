...
import { renderDiplomacyTab } from './tabs/diplomacy-tab.js';
import { renderDrillFloorTab } from './tabs/drill-floor-tab.js';
...
function renderTabBar() {
  ...
  // The 'copilot' tab follows the same dark-by-default gate: with the
  // guardedCopilot flag off (its shipped default) it is never added to the bar,
...
// ============================================================
// Data Diplomacy Tab wiring
// ============================================================
// Extracted to js/app-shell/tabs/diplomacy-tab.js during the Structural
// Readiness Phase item 3 (main.js monolith paydown, 2026-09-26). See that
// file for the full history/comments; renderDiplomacyTab is imported at the
// top of this file and behaves byte-for-byte identically (no dependency-
// injection needed -- every identifier it uses is independently importable).
...
// ============================================================
// Drill Floor Tab wiring
// ============================================================
// Extracted to js/app-shell/tabs/drill-floor-tab.js during the Structural
// Readiness Phase item 3 (main.js monolith paydown, batch 2b part 2,
// 2026-09-26). See that file for the full history/comments; renderDrillFloorTab
// is imported at the top of this file and behaves byte-for-byte identically.
// It takes a small deps object ({ ensurePythonRuntime, ensureRRuntime }) since
// those two functions are also called directly from this file's own tab
// dispatch (for the Python/R tabs) and so remain defined here.
