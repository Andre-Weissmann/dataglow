...
- Generated: `2026-07-08T02:35:49.903Z`
- Registry reachable: yes
- Dependencies tracked: **3** (🟢 3 ok · 🟡 0 warn · 🔴 0 fail)
- Staleness: 2 current · 0 patch · 1 minor · 0 major behind
- Security advisories (npm audit): **0** (🔴 0 fail-level · 🟡 0 warn-level)
...
| 🟢 ok | `@duckdb/node-api` | dev | 1.5.4-r.1 | 1.5.4-r.1 | — | — |
| 🟢 ok | `playwright-chromium` | dev | 1.61.1 | 1.61.1 | — | — |

## Security advisories

_None reported by `npm audit`._
